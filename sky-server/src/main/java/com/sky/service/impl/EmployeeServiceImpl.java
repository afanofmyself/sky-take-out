...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public void save(EmployeeDTO employeeDTO) {
        Employee employee = new Employee();//z这是实体类
        ...
        //设置密码
        employee.setPassword(DigestUtils.md5DigestAsHex(PasswordConstant.DEFAULT_PASSWORD.getBytes()));//对密码进行加密
    ...
    public PageResult pageQuery(EmployeePageQueryDTO employeePageQueryDTO) {
        //mybatis的pagehelper,在工程的pom中配置了
        // 开始分页查询
